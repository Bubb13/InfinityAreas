...
public class CustomScrollPane extends ScrollPane
{
    ...
    //////////////////////////
    // CustomScrollPaneSkin //
    //////////////////////////

    public class CustomScrollPaneSkin extends SkinBase<ScrollPane>
    {
        /* *************************************************************************
         *                                                                         *
         * Static fields                                                           *
         ...
         */
        public CustomScrollPaneSkin(final ScrollPane control)
        {
            super(control);

            // install default input map for the ScrollPane control
            behavior = new CustomScrollPaneBehavior(control);
        ...
        private final void setContentPosX(double value)
        {
        ...
        private final DoubleProperty contentPosXProperty()
        {
            if (contentPosX == null)
            {
                contentPosX = new DoublePropertyBase()
                {
                    ...
                    {
                        return CustomScrollPaneSkin.this;
                    }
...
//        setManaged(false);
            ...
            viewRect.addEventHandler(ScrollEvent.SCROLL, event ->
            {
                ...
                if (vsb.getVisibleAmount() < vsb.getMax())
                {
                    ...
                    else
                    {
                         ...
                         */
                        if (!(event.isInertia()) || (event.isInertia()) && (contentsToViewTimeline == null || contentsToViewTimeline.getStatus() == Animation.Status.STOPPED))
                        {
                            vsb.setValue(newValue);
        ...
        private void startContentsToViewport()
        {
             ...
             ** reposition
             */
            contentsToViewKF2 = new KeyFrame(Duration.millis(150),
                event ->
                {
                    getSkinnable().requestLayout();
                },
    ...
    //////////////////////////////
    // CustomScrollPaneBehavior //
    //////////////////////////////

    public class CustomScrollPaneBehavior extends BehaviorBase<ScrollPane>
    {
        ...
        public CustomScrollPaneBehavior(ScrollPane scrollPane)
        {
            super(scrollPane);
